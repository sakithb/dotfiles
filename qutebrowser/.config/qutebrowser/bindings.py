...
config.bind("wh", "devtools left", mode="normal")
config.bind("wj", "devtools bottom", mode="normal")
config.bind("wk", "devtools top", mode="normal")
config.bind("wl", "devtools right", mode="normal")
...
config.bind(";t", "hint input --first", mode="normal")
config.bind(";T", "hint input", mode="normal")
...
config.bind("t<Print>", "print", mode="normal")
